...
urlpatterns = [
    ...
    path('pantallaInicioPaciente/', views.pantallaInicioPaciente, name = "pantallaInicioPaciente"),
    ...
    path('accionEditarPerfil/', views.accionEditarPerfil,name= 'accionEditarPerfil'),
    path('SaleInvoicePdfViewf/', SaleInvoicePdfViewf.as_view(),name= 'sale_invoice_pdf'),
    path('SaleInvoicePdfViewG/', SaleInvoicePdfViewG.as_view(),name= 'sale_invoice_pdf'),
    path('SaleInvoicePdfViewFA/', SaleInvoicePdfViewFA.as_view(),name= 'sale_invoice_pdf'),
